...
function register_team_post_type() {
    $labels = array(
        ...
        'featured_image'        => _x( 'Team Member Image', 'Overrides the “Featured Image” phrase', 'twentytwentyfive' ),
        'set_featured_image'    => _x( 'Set team member image', 'Overrides the “Set featured image” phrase', 'twentytwentyfive' ),
        'remove_featured_image' => _x( 'Remove team member image', 'Overrides the “Remove featured image” phrase', 'twentytwentyfive' ),
        'use_featured_image'    => _x( 'Use as team member image', 'Overrides the “Use as featured image” phrase', 'twentytwentyfive' ),
        'archives'              => _x( 'Team member archives', 'The post type archive label', 'twentytwentyfive' ),
    );
