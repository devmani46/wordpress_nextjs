    ...
    <?php if ($query_faq->have_posts()) : $count = 0; ?>
      <?php while ($query_faq->have_posts()) : $query_faq->the_post();
        ...
        <div class="faq-item border border-gray-300 rounded p-4 mb-3">
          <?php if ($category) : ?>
            <span class="inline-block bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded mb-2"><?= esc_html($category); ?></span>
          <?php endif; ?>
          <button class="faq-button flex justify-between w-full text-left" onclick="toggleFAQ(this)">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 28 28">
              <path d="M19.8327 11.6667L13.9993 17.5L8.16602 11.6667" stroke="#525775" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </button>
