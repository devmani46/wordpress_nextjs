jQuery(document).ready(function($) {
    ...
    $(document).on('click', '.add-download', function() {
        ...
        var newRow = '<tr class="download-row">' +
            '<td><input type="text" name="event_downloads[' + downloadCount + '][title]" class="wide-input"></td>' +
            '<td>' +
                '<div class="file-preview-container">' +
                    '<input type="hidden" name="event_downloads[' + downloadCount + '][file]" class="download-file-id">' +
    ...
    $(document).on('click', '.remove-download', function() {
        ...
        $('.download-row').each(function(index) {
            $(this).find('input[name*="event_downloads"]').each(function() {
                var name = $(this).attr('name');
                name = name.replace(/\[\d+\]/, '[' + index + ']');
                $(this).attr('name', name);
            });
